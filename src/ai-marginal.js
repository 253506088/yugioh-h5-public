(function(root){
  ...
  const traceKeys=new Set(['log','chainHistory','startedAt','chainId','nextUid','nextLog','nextLink','nextTrigger','nextChain',
    ...
    'used','usedTurn','duelUsed','actionsThisTurn','effectActivations','lpPaidByTurn','inputRoles','targetMeta','sourceUnavailableByNumber','effectNegatedByNumber','preventionState','deckSpec','earlySent']);
