...
const files=['tests/engine.test.cjs','tests/v2-core.test.cjs','tests/v2-regression.test.cjs','tests/v3-rules.test.cjs','tests/v4-rules.test.cjs','tests/v4-2002.test.cjs','tests/v4-2002-sweep.test.cjs','tests/yearly-collector.test.mjs','tests/game-art.test.mjs','tests/collection-progress.test.mjs','tests/i18n.test.cjs'];
