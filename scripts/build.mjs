...
const assets = {};
assets['card-back'] = 'data:image/svg+xml;base64,' + (await readFile(join(root, 'assets/art/card-back.svg'))).toString('base64');
...
const styleFiles = ['style.css', 'expansion.css', 'link.css', 'early.css'];
...
scriptFiles.splice(scriptFiles.indexOf('audio.js'),0,'card-locales.js','i18n-data.js','i18n-effects.js','i18n-help.js','i18n.js');
