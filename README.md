...
> 当前收录至 2014 年的 OCG 日期候选快照，共 **6,871 张可组卡卡片、46 套预设**，2014 年 613 个身份全部登记效果、没有待实现卡。后续年份先读 [2014 批次交接](交接/2014批次交接.md)（含逐卡实现方法与踩坑清单）与 [AI 名录与年度维护交接](交接/AI卡片名录与2014以后年度维护交接.md)；2013 批次见 [交接](交接/2013批次交接.md) 与 [验证记录](docs/verification-2013.md)。


**6,871 张卡片 · 46 套预设 · 中文 / English / 日本語 · 全召唤方式 · 单 HTML**

**新增[天命法则](docs/rule-modes.md)**：每局等概率抽取一条不可无效、双方共享的常驻法则，共 25 条。首页进入法则图鉴，或在新决斗中选择「天命法则」。支持人机、机器人观战、淘汰赛逐局抽取及联机房间；开局揭晓、战场规则栏、苦肉行动和血祭召唤均已接入。普通决斗仍使用经典规则。后续年度开发请同时阅读[规则模式维护交接](交接/天命法则与后续年度卡片维护.md)。
...
项目保留1999—2014十六年本地快照，共6,805个供应方身份。黑羽、蛙炮、神光、代行、废二、六武、甲虫装机、发条、水精鳞海皇、征龙、魔导书、影灵衣、机壳、影依等可以直接选择出战。图鉴和工坊支持单年／累计年份，新决斗支持年度预设筛选。

总卡池还保留83张年度快照范围外的手工卡，包含后续时代的既有支援。全库名录另有14,981条名称/密码记录用于识别未收录卡，不代表这些卡都已实现。
...
- [根据描述联网组卡](docs/ai-deck-research.md)：实际搜索公开牌表，在来源卡片范围内推荐/调整，附原帖、作者、逐卡来源和本地数量校验。
- [优化问题 2](docs/optimization-2.md)：弹窗逐层返回、双语清单、黑话与多主题构筑、2010 世界冠军原牌表和每局随机 BGM。
...
| `npm run test:deck-research` | 联网检索、来源校验、补正及多主题浏览器验证 |
| `npm run test:optimization-2` | 双语清单、分层返回、遮罩与每局 BGM 回归 |
