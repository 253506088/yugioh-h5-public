...
> 当前收录至 2013 年的 OCG 日期候选快照，共 **6,275 张可组卡卡片、43 套预设**。后续年份先读 [AI 名录与年度维护交接](交接/AI卡片名录与2014以后年度维护交接.md)；2013 批次见 [交接](交接/2013批次交接.md) 与 [验证记录](docs/verification-2013.md)。


**6,275 张卡片 · 43 套预设 · 中文 / English / 日本語 · 全召唤方式 · 单 HTML**
...
项目保留1999—2013十五年本地快照，共6,192个供应方身份。黑羽、蛙炮、神光、代行、废二、六武、甲虫装机、发条、水精鳞海皇、征龙、魔导书等可以直接选择出战。图鉴和工坊支持单年／累计年份，新决斗支持年度预设筛选。
