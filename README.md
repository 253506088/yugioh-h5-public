...
> 当前收录至 2015 年的 OCG 日期候选快照，共 **7,486 张可组卡卡片、49 套预设**，2015 年 623 个身份全部登记效果、没有待实现卡。新增世界冠军星骑士、世界亚军影灵衣及年末娱乐伙伴娱乐法师三套构筑。详见 [2015 批次交接](交接/2015批次交接.md)、[年度牌组说明](docs/decks-2015.md) 与 [验收记录](docs/verification-2015.md)。后续年度须遵循 [系列归属规范](交接/新增卡片系列归属规范.md) 与 [AI 名录维护交接](交接/AI卡片名录与2014以后年度维护交接.md)。


**7,486 张卡片 · 49 套预设 · 中文 / English / 日本語 · 全召唤方式 · 单 HTML**
...
项目保留1999—2015十七年本地快照，共7,428个供应方身份。黑羽、蛙炮、神光、代行、废二、六武、甲虫装机、发条、水精鳞海皇、征龙、魔导书、影灵衣、机壳、影依等可以直接选择出战。图鉴和工坊支持单年／累计年份，新决斗支持年度预设筛选。

总卡池还保留58张年度快照范围外的手工卡，包含后续时代的既有支援。全库名录另有14,981条名称/密码记录用于识别未收录卡，不代表这些卡都已实现。
