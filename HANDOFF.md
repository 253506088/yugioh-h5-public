...
最新批次为 **6,275 张卡、41 套预设**；新增 2013 年 528 个供应方身份，其中 201 张已登记逐卡效果、320 张仍为「效果待落实」。三套年度代表构筑为征龙（2013 世界冠军）、魔导书（世界亚军）、入魔（OCG 上位第 3，因八强只有两种体系而按人气规则替换季军同款）。源码、修复的跨年问题、复现与提交范围见 [2013 批次交接](交接/2013批次交接.md)。
